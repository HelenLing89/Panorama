...
@interface PanoCController ()<WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate>
...
@implementation PanoCController
...
- (WKWebView *)webView{
    if(_webView == nil){
        ...
        //[config setValue:@NO forKey:@"_disable local file restrictions"];
      ...
      //  WKBackForwardList * backForwardList = [_webView backForwardList];
        ...
        //NSString *path = [[NSBundle mainBundle] pathForResource:@"upThree/index.html" ofType:nil];
...
- (void)setupDataArr {
    ...
    NSDictionary *dic = [self parseXMLWithPath:@"CUnder/pano.xml"];
    [self.dataM addObject:dic];
    NSMutableArray *dicArr = [NSMutableArray array];
    NSArray *dicarray = dic[@"node6"];
    [dicArr addObject:dicarray[0]];//地下室入口
    NSArray *dicarray1 = dic[@"node2"];
    [dicArr addObject:dicarray1[0]];//画廊1
    [dicArr addObject:dicarray[1]];//画廊2
    [dicArr addObject:dicarray1[1]];//影音室
    [dicArr addObject:dicarray1[2]];//会客厅
    NSArray *dicarray2 = dic[@"node4"];
    [dicArr addObject:dicarray2[0]];//走廊
    [self.allDataM addObject:dicArr];
    NSDictionary *dic1 = [self parseXMLWithPath:@"COne/pano.xml"];
    [self.dataM addObject:dic1];
    NSMutableArray *dic1Arr = [NSMutableArray array];
    NSArray *dic1array = dic1[@"node2"];
    [dic1Arr addObject:dic1array[0]];//餐厅
    NSArray *dic1array1 = dic1[@"node1"];
    [dic1Arr addObject:dic1array1[0]];//会客厅1
    [dic1Arr addObject:dic1array[1]];//会客厅2
    [dic1Arr addObject:dic1array[2]];//阳台
    [self.allDataM addObject:dic1Arr];
    NSDictionary *dic2 = [self parseXMLWithPath:@"CTwo/pano.xml"];
    [self.dataM addObject:dic2];
    NSMutableArray *dic2Arr = [NSMutableArray array];
    NSArray *dic2array = dic2[@"node6"];
    [dic2Arr addObject:dic2array[0]];//卧室1
    NSArray *dic2array1 = dic2[@"node1"];
    [dic2Arr addObject:dic2array1[1]];//卧室1卫生间
    [dic2Arr addObject:dic2array[1]];//卧室2
    [dic2Arr addObject:dic2array1[2]];//走廊1
    [dic2Arr addObject:dic2array[2]];//走廊2
    NSArray *dic2array2 = dic2[@"node3"];
    [dic2Arr addObject:dic2array2[0]];//阳台1
    NSArray *dic2array3 = dic2[@"node2"];
    [dic2Arr addObject:dic2array3[1]];//阳台2
...
- (void)addChooseBtn {
    ...
    self.underView = [[UIView alloc] initWithFrame:CGRectMake(0, 10 * 0.5 *kW, 240 *0.5 *kW *6, 220 * 0.5 *kH)];
    ...
    [self addChoiceBtnOnView:self.underView WithImageArr:@[@"C负一层地下室入口.jpg",@"C负一层画廊1.jpg",@"C负一层画廊2.jpg",@"C负一层影音室.jpg",@"C负一层地下室会客厅.jpg",@"C负一层走廊.jpg"] WithTitleArr:@[@"地下室入口",@"画廊1",@"画廊2",@"影音室",@"地下室会客厅",@"走廊"]];
    self.oneView = [[UIView alloc] initWithFrame:CGRectMake(0,10 * 0.5 *kW,240 *0.5 *kW *4, 220 * 0.5 *kH)];
    ...
    [self addChoiceBtnOnView:self.oneView WithImageArr:@[@"C一楼餐厅.jpg",@"C一楼会客厅1.jpg",@"C一楼会客厅2.jpg",@"C一楼阳台.jpg"] WithTitleArr:@[@"餐厅",@"会客厅1",@"会客厅2",@"阳台"]];
    self.twoView = [[UIView alloc] initWithFrame:CGRectMake(0, 10 * 0.5 *kW, 240 *0.5 *kW *7, 220 * 0.5 *kH)];
    ...
    [self addChoiceBtnOnView:self.twoView WithImageArr:@[@"C二层卧室1.jpg",@"C二层卧室1卫生间.jpg",@"C二层卧室2.jpg",@"C二层走廊1.jpg",@"C二层走廊2.jpg",@"C二层阳台1.jpg",@"C二层阳台2.jpg"] WithTitleArr:@[@"卧室1",@"卧室1卫生间",@"卧室2",@"走廊1",@"走廊2",@"二层阳台1",@"二层阳台2"]];
...
- (void)houseBtnClick:(UIButton *)btn {
    ...
    NSString *path;
    if (btn.tag == 0) {
        path = [[NSBundle mainBundle] pathForResource:@"CUnder/index" ofType:@"html"];
    }else if (btn.tag == 1) {
        path = [[NSBundle mainBundle] pathForResource:@"COne/index" ofType:@"html"];
    }else if (btn.tag == 2) {
        path = [[NSBundle mainBundle] pathForResource:@"CTwo/index" ofType:@"html"];
    }
    NSError *error = nil;
...
- (void)customBtnClick:(LTCustomBtn *)customBtn {
    if (customBtn != self.lastSelectedBtn) {
        ...
        if (self.lastSelectedHouseBtn.tag == 0) {
            if (self.lastSelectedBtn.tag == 0) {//地下室入口  node4
                array = dic[@"node4"];
                if (customBtn.tag == 5) {
                    subArray = array[0];
                }else{
            ...
            }else if (self.lastSelectedBtn.tag == 1){//画廊1 node1
                array = dic[@"node1"];
                if (customBtn.tag == 0){
                    subArray = array[1];
            ...
            }else if (self.lastSelectedBtn.tag == 2) {//画廊2 node2
                array = dic[@"node2"];
                if (customBtn.tag == 1){
                    subArray = array[0];
            ...
            }else if (self.lastSelectedBtn.tag == 3) {//影音室 node5
                array = dic[@"node5"];
                if (customBtn.tag == 1){
                   subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 4) {//会客厅 node3
                array = dic[@"node3"];
                if (customBtn.tag == 1){
                    subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 5) {//走廊 node6
                array = dic[@"node6"];
                if (customBtn.tag == 0){
                    subArray = array[0];
                }else if (customBtn.tag == 2){
            ...
            if (self.lastSelectedBtn.tag == 0) {//一层餐厅  node1
               array = dic[@"node1"];
                if (customBtn.tag == 1) {
                    subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 1){//会客厅1 node2
               array = dic[@"node2"];
                if (customBtn.tag == 0){
                    subArray = array[0];
                }else if (customBtn.tag == 2){
            ...
            }else if (self.lastSelectedBtn.tag == 2) {//会客厅2 node3
                array = dic[@"node3"];
                if (customBtn.tag == 1){
                   subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 3) {//一楼阳台 node4
                   array = dic[@"node4"];
                    if (customBtn.tag == 1){
                      subArray = array[0];
                    }else {
            ...
            if (self.lastSelectedBtn.tag == 0) {//卧室1  node1
                array = dic[@"node1"];
                if (customBtn.tag == 1) {
                    subArray = array[1];
                }else if (customBtn.tag == 3){
                    subArray = array[2];
                }else if (customBtn.tag == 6){
                    subArray = array[0];
                }else {
                    subArray = allDataArr[customBtn.tag];
                }
            }else if (self.lastSelectedBtn.tag == 1){//卧室1卫生间 node2
                array = dic[@"node2"];
                if (customBtn.tag == 0){
                    subArray = array[0];
                }else if (customBtn.tag == 6){
            ...
            }else if (self.lastSelectedBtn.tag == 2) {//卧室2 node3
                array = dic[@"node3"];
                if (customBtn.tag == 3){
                    subArray = array[1];
                }else if (customBtn.tag == 5){
                    subArray = array[0];
                }else {
                    subArray = allDataArr[customBtn.tag];
                }
            }else if (self.lastSelectedBtn.tag == 3) {//走廊1 node6
               array = dic[@"node6"];
                if (customBtn.tag == 0){
                    subArray = array[0];
                }else if (customBtn.tag == 2) {
            ...
            }else if (self.lastSelectedBtn.tag == 4) {//走廊2 node7
                 array = dic[@"node7"];
                if (customBtn.tag == 3){
                subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 5) {//阳台1 node4
                array = dic[@"node4"];
                if (customBtn.tag == 2){
                    subArray = array[0];
                }else {
            ...
            }else if (self.lastSelectedBtn.tag == 6) {//阳台2 node5
                array = dic[@"node5"];
                if (customBtn.tag == 0){
                    subArray = array[0];
        ...
        if([message.name isEqualToString:@"jsToOcWithPrams"]){
            ...
            if (self.lastSelectedHouseBtn.tag == 0) {
                ...
                if ([str  isEqual: @"{node1}"]) {
                    ...
                    btn = btnView.subviews[3];
                }else if ([str  isEqual: @"{node7}"]){
                    btn = btnView.subviews[4];
                }else if ([str  isEqual: @"{node4}"]){
                    btn = btnView.subviews[5];
                }else if ([str  isEqual: @"{node5}"]){
                    btn = btnView.subviews[6];
                }
            }
